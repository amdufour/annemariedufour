      ...
      <section className="page-about">
        ...
        <div className="page-content">
          <div className="container">
            ...
            <p>Now that you’ve reached my about page, you probably already know that I Design and Develop creative Data Visualizations. If you came here to confirm if my soft skills, technical expertise, and main tools match the project you have in mind, the button below will bring you precisely to the right place.</p>
            ...
            <p>In 2018, I stumbled across the work of <a href="https://www.visualcinnamon.com/" target="_blank" rel="noreferrer">Nadieh Bremer</a>, where I discovered that data visualizations could also be extremely creative. I knew right ahead that I HAD to do something similar. It was the type of urge that is impossible to ignore. Having just had a new baby at the time, I took things slowly. I went back to the maths I had learned earlier and gained new skills like data analysis with python and data visualizations development with d3.js.</p>
