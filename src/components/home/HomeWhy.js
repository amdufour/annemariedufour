      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-8 offset-md-2">
            ...
            <p>Effective visual communication makes us feel emotionally connected to the reality presented. <span className="emphasis">Data Visualization is a tool of choice to raise awareness, convince and reveal hidden stories.</span></p>
